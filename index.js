 ...
 * }
*/
function makePersonObject(idArgument, nameArgument, emailArgument) {
  const personObject = {
    id: idArgument,
    name: nameArgument,
    email: emailArgument
...
// const me = makePersonObject(34, 'Ben', 'ben@little-haus.com');
// console.log(me);
/**
 * ### Challenge `getName`
 * 
...
function getCarInfoByIndex(inventory, index) {
  ...
  return `This is a ${carInfoByIndex.car_make} ${carInfoByIndex.car_model}`; //back-ticks, ugh so much wasted time
};
...
//   { id: 2, car_make: "Mazda", car_model: "Miata MX-5", car_year: 2001 },
//   { id: 3, car_make: "Land Rover", car_model: "Defender Ice Edition", car_year: 2010 }]
// let carTest = inventoryTest[1];
// console.log(carTest.car_make);
/////////////////
...
function sortCarInventory(inventory) {
  ...
  const sortedCars = inventory.sort(function (a, b) {
...
function carMaker(mileage) {
  let carMileage = {
    ...
    drive: function (distance) {
      this.odometer += distance; //not sure why 'this.odometer = mileage + distance;' didsn't work here
